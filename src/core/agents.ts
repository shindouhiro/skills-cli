...
export const AGENTS: AgentDefinition[] = [
  { name: 'Antigravity', id: 'antigravity', projectDir: '.agent/skills/', globalDir: '~/.gemini/config/skills/', extraGlobalDirs: ['~/.gemini/antigravity/skills/', '~/.agents/skills/'], icon: 'ai:antigravity-color' },
