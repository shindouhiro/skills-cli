  ...
  >
    <div class="flex w-[500px] max-w-full flex-col overflow-hidden rounded-2xl border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-900 shadow-2xl">
      ...
      <div class="space-y-4 p-6">
        <div>
          <label class="mb-1 block text-sm font-medium text-slate-700 dark:text-slate-300" for="target-name-input">名称 <span class="text-red-400">*</span></label>
          <input
        ...
        <div>
          <label class="mb-1 block text-sm font-medium text-slate-700 dark:text-slate-300" for="target-url-input">Git 远端 URL <span class="text-red-400">*</span></label>
          <input
            id="target-url-input"
            :value="url"
        ...
        <div>
          <label class="mb-1 block text-sm font-medium text-slate-700 dark:text-slate-300" for="target-path-input">技能子目录名称</label>
          <input
        ...
        <div>
          <label class="mb-1 block text-sm font-medium text-slate-700 dark:text-slate-300" for="target-branch-input">目标分支</label>
          <input
        ...
        <div class="mt-2 flex items-center gap-2">
          ...
          >
          <label for="target-global-checkbox" class="cursor-pointer text-sm text-slate-700 dark:text-slate-300">保存到全局配置 (~/.skillsrc)</label>
        </div>
      </div>
